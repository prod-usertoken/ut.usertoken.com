...
const serverWorker = require('./controllers/serverWorker');
...
const gunOptions = {
    level: levelDB,
    file: false,
    peers: ['https://graphql.pointlook.com'],
    web: server,
    s3: {
      key: '', // AWS Access Key
 ...
 * UserToken routes
 */
app.get('/gun', function(req, res){ res.status(200).send('❤') } );
app.get('/pki', serverWorker.genKeys);
app.get('/encrypt', serverWorker.encrypt);
